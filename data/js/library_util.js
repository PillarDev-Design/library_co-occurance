 ...
 * library_util.js                                                            *
 * -------------------------------------------------------------------------- *
 * Contains various util functions and d3 visualizations.                     *
\******************************************************************************/
...
function initialize() {
    ...
    d3.json('/data/json/alachua_new.json', function(libraries) {
        ...
        // Convert links to matrix; counter character occurances
        libraries.links.forEach(function(link) {
